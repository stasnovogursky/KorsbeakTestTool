...
namespace KorsbeakTestTool.Token
{
    ...
    {
        public SecurityToken GetSamlToken(string cvr, string entityId)
        {
            ...
            return SendSecurityTokenRequest(absoluteUri, certificate, cvr);
        }

        private SecurityToken SendSecurityTokenRequest(string appliesTo, X509Certificate2 clientCertificate, string cvr)
        {
